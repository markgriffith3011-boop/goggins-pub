...
const timeline: TimelineEntry[] = [
  ...
  {
    year: 'Recent years',
    text: 'Trade declined after 2020 and the pub has been closed for the past two years — a period needed to secure the future of the property and the business.',
  },
  {
    year: 'Today',
